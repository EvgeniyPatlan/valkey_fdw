...
REGRESS = smoke probe options ddl mapping scan fetch legacy position ttl ttl_absent io bulk pool leak val vec knnplan wbuf modify script dml overlay tls probe_tls acl probe_acl wfault resp cluster vsearch knn priv
#
